...
<body>
	...
	<div id="toolbar">
		...
		<div>
			...
			学生名：<input id="search-username" class="easyui-textbox" />
			所属班级：
    	...
    	<form id="editPhotoForm" method="post" enctype="multipart/form-data" action="upload_photo" target="photo_target">
   		...
   		<form id="editForm" method="post">
	    	...
	    	<table id="editTable2" cellpadding="8" >
	    		...
	    		<tr>
	    			<td>备注：</td>
	    			<td ><textarea id="edit_remark" style="width: 250px; height: 180px;" name="remark" data-option="multiline:true"></textarea></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
