...
<head>
	...
	//获取Controller传来的gradeListJson数组对象
	...
	$(function() {	
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "如果班级下存在学生信息则无法删除，须先删除班级下学生的信息", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "delete",
...
<body>
	...
	<div id="toolbar">
		...
		<div>
			...
			所属年级：
			<select id="search-grade-id" class="easyui-combobox" style="width: 200px; ">
	...
	<div id="addDialog" style="padding: 10px;">  
   		<form id="addForm" method="post">
	    	<table id="addTable" cellpadding="8" >
	    		...
	    		<tr>
	    			<td>备注：</td>
	    			<td ><textarea id="add_remark" style="width: 250px; height: 180px;" name="remark" data-option="multiline:true"></textarea></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
	...
	<div id="editDialog" style="padding: 10px">
    	...
    	<form id="editForm" method="post">
	    	<table id="editTable" border=0 cellpadding="8" >
	    		...
	    		<tr>
	    			<td>备注：</td>
	    			<td ><input id="edit_remark" style="width: 200px; height: 30px;" class="easyui-textbox" type="remark" name="remark" data-options="required:true, missingMessage:'请填写密码'" /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
