...
<head>
    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						...
						{"menuid":"3","icon":"","menuname":"年级信息列表",
							"menus":[
									{"menuid":"31","menuname":"年级列表","icon":"icon-world","url":"../grade/list"},
								]
						},
						{"menuid":"4","icon":"","menuname":"班级信息列表",
							"menus":[
...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="padding-left:10px; font-size: 16px; ">【翁煌】学生信息管理系统</span>
    </div>
    <div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
        <div class="footer">Copyright &copy; 翁煌</div>
    </div>
