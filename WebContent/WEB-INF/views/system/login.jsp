...
<script type="text/javascript">
	$(function(){
		...
		$("#vcodeImg").click(function(){
			this.src="get_cpacha?vl=5&w=150&h=38&t="+new Date().getTime();
		});
		//登录
		$("#submitBtn").click(function(){
			...
			$.ajax({
				type: "post",
				url: "login",
				data: data,   //加上url 类似于get_cpacha?vl=5&w=150&h=38
    ...
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          ...
          <img title="点击图片切换验证码" id="vcodeImg" src="get_cpacha?vl=5&w=150&h=38"></div>
      </div>
...
<div class="footer">Copyright &nbsp;  @ wenghuang </div>
